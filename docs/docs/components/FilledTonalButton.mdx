...
<!-- Source: src/button/FilledTonalButton.tsx -->
...
```ts
import {FilledTonalButton} from 'material-expressive-react';
import {FilledTonalButton} from 'material-expressive-react/button';
```
