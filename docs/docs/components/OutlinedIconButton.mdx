...
<!-- Source: src/icon-button/OutlinedIconButton.tsx -->
...
```ts
import {OutlinedIconButton} from 'material-expressive-react';
import {OutlinedIconButton} from 'material-expressive-react/icon-button';
```
