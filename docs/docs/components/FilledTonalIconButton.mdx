---
title: FilledTonalIconButton
---

<!-- AUTO-GENERATED FILE. DO NOT EDIT DIRECTLY. -->
<!-- Source: src/icon-button/FilledTonalIconButton.tsx -->
...
```ts
import {FilledTonalIconButton} from 'material-expressive-react';
import {FilledTonalIconButton} from 'material-expressive-react/icon-button';
```
